...
export const metadata: Metadata = {
  title: "إخلاء المسئولية | Railo Egypt",
}
    ...
    <div dir="rtl" className="min-h-screen bg-background">
      <div className="mx-auto max-w-3xl px-6 py-12">
        ...
        <div className="space-y-1 text-sm leading-7 [&_h2]:mt-6 [&_h2]:mb-3 [&_h2]:text-base [&_h2]:font-semibold [&_ul]:mr-4 [&_ul]:list-disc [&_ul]:space-y-1 [&_p]:mb-3">
          ...
          <p>تطبيق Railo Egypt هو مشروع اجتهاد شخصي مستقل تماماً، وليس له أي علاقة أو ارتباط بهيئة السكك الحديدية المصرية أو أي جهة حكومية أو خاصة أخرى. التطبيق لا يمثل الموقف الرسمي لأي جهة.</p>
